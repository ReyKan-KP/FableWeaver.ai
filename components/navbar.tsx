...
export function Navbar() {
  ...
  return (
    <motion.nav
      className="fixed bg-[#d6d5df] dark:bg-[#1e1e1f] top-10 left-10 right-10 px-20 py-2 z-50 rounded-full bg-opacity-50 dark:bg-opacity-50 backdrop-blur-lg shadow-lg border border-neutral-200 dark:border-white/[0.2]"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link
          href="/"
          className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-blue-600 to-teal-500 text-transparent bg-clip-text"
        ...
        <div className="flex items-center space-x-4">
          {status === "authenticated" && session ? (
            ...
            <div className="hidden md:flex items-center pl-8 space-x-16">
